...
The main factorial reuses the exact pre-registered S1 set and gain on all
20 held-out E1 prompts. It crosses S1 off/on with free, forced-\texttt{a},
and forced-\texttt{an} articles, and runs both recomputed- and
frozen-attention semantics. Primary intervals are prompt-level
